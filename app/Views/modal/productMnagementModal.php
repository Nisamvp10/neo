...
<div id="productManageModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 wrapModal">
  <div class="bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[100vh] min-h-[80vh] overflow-scroll">
               ...
               <div id="step1" class="step">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                        ...
                        <div>
                         ...
                         <!-- Product Type -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1 font-semibold mt-4 block">Product  Type</label>
                            <select id="product_type" name="type" class="w-full border p-3 rounded mt-2" id="product_type">
                        ...
                        <!-- open -->
                          <!-- ================= NORMAL PRODUCT ================= -->
                            <div id="normal_section">
                              ...
                              <div class="section-card">
                                    <div class="flex items-center justify-between mb-5">
                                        ...
                                        <button type="button" id="addSizeNormal" class="btn-add">+ Add Size</button>
                                    </div>
                                    <div id="normalSizeContainer" class="mt-3 space-y-2"></div>
                                </div>

                                <!-- Add-ons -->
                                 <div class="section-card">
                                    <div class="flex items-center justify-between mb-5">
                                        <h2 class="title !mb-0">Add Ons</h2>
                                        <button type="button" id="addAddon" class="btn-add">+ Add Addon</button>
                                    </div>
                                    <div id="addonContainer" class="space-y-4"></div>
                                </div>
                                   ...
                                   <!-- COLORS -->
                                    <div class="section-card">
                                        <div class="flex items-center justify-between mb-5">
                                            <h2 class="title !mb-0">Colors</h2>
                                            <button type="button" id="addColor" class="btn-add">+ Add Color</button>
                                        </div>
                            ...
                            <div id="custom_section" style="display:none;">
                                ...
                                <div class="section-card">
                                    <div class="flex items-center justify-between mb-5">
                                        <h2 class="title !mb-0">Fonts Pricing</h2>
                                        <button type="button" type="button" id="addFont" class="btn-add">+ Add Font</button>
                                    </div>
                    ...
                    <div class="bg-card rounded-xl p-6 space-y-6 border border-border mt-2">
                        <div class="grid gap-4 sm:grid-cols-4">
                            ...
                            <!--  -->
                             <div class="space-y-2">
                                <div class=" border border-border p-2 rounded-xl">
                                    <h4 class="text-lg font-medium">Latest Product</h4>
                                    <p class="text-sm text-muted-foreground">Active products are visible in your Latest List</p>
                                    <label class="form-check form-switch mt-2">
                                        <input class="form-check-input" id="latest" type="checkbox" name="latest" >
                                    </label>
                                </div>
                            </div>
                            <!--  -->
