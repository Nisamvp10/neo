    ...
    <footer class="footer-area bg-image">
        <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.1s" data-wow-delay=".1s">
                        <div class="footer__item">
                            ...
                            <ul>
                                <li><a href="#"><span></span>Help Portal</a></li>
            ...
            <div class="footer__copy-text pt-50 pb-50">
                ...
                <p>&copy; Copyright 2026 <a href="#0" class="primary-hover">Neon Stories</a> All Rights Reserved</p>
                <a href="#0" class="payment d-block image">
                    <img src="<?=base_url('public/assets/template/');?>assets/images/payment.png" alt="icon">
                </a>
            </div>
        </div>
    </footer>
