...
class HomeController extends BaseController {
    ...
    public function index() {
        ...
        $premiumProducts = $this->productManageModel->where(['product_status' => 1,'premium_product' =>1])->orderBy('id','DESC')->limit(10)->get()->getResult();
        $featuredProducts = $this->productManageModel->where(['product_status' => 1,'featured_product' =>1])->orderBy('id','DESC')->limit(10)->get()->getResult();
        $latestProducts = $this->productManageModel->where(['product_status' => 1,'latest_product' =>1])->orderBy('id','DESC')->limit(10)->get()->getResult();
        ...
        return view('frontend/index',compact('page','banner','tagline','industries','feedback','news','srevices','itemCategories','premiumProducts','featuredProducts','latestProducts'));
